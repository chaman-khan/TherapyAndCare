      ...
      <View>
        {mapInitialized && (
          <View
            ...
            <TouchableOpacity style={{...styles.info,  marginTop: item ? height - height / 2 : height - height / 2.2,}} activeOpacity={1} onPress={() => item ? navigation.navigate('TimeOUt', {item}) : null}>
              <TouchableOpacity
                onPress={() =>
